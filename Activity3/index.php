<html>
    ...
    <body>
            ...
            <div class="panel-group" id="myaccordion">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h4><a href="#colap1" data-toggle="collapse in" data-parent="#myaccordion">Collapsible Accordion</a></h4>
                    </div>
                    <div id="colap1" class="collapse panel-collapse">
                        <div class="panel-body">
                            <p>You can put anything here for your content</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><a href="#colap2" data-toggle="collapse in" data-parent="#myaccordion">Collapsible Accordion</a></h4>
                    </div>
                    <div id="colap2" class="collapse panel-collapse">
                        <div class="panel-body">
                            <p><img src="pic/MyProfile.jpg"></p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h4><a href="#colap3" data-toggle="collapse in" data-parent="#myaccordion">Collapsible Accordion</a></h4>
                    </div>
                    <div id="colap3" class="collapse panel-collapse">
                        <div class="panel-body">
                            <p>You can put anything here for your content</p>
                        </div>
                    </div>
                ...
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h4><a href="#colap4" data-toggle="collapse in" data-parent="#myaccordion">Collapsible Accordion</a></h4>
                    </div>
                    <div id="colap4" class="collapse panel-collapse">
                        <div class="panel-body">
                            <p>You can put anything here for your content</p>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="panel-group">
                <div class="panel panel-default">
                    ...
                    <div id="efg" class="collapse panel-collapse">
                        <ul class="list-group">
        ...
        <div class="container">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h4><a href="#abc" data-toggle="collapse in">This is a panel heading</a></h4>
                </div>
                <div id="abc" class="panel-collapse collapse in">
                    <div class="panel-body">
        ...
        <div class="container">
            ...
            <div id="dtx" class="collapse in"><img src="pic/MyProfile.jpg" ></div>
        </div>
